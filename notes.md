...
Iniciando o projeto Sorteador de números

## Desafio Prático
## Sobre o desafio
Neste desafio, você vai desenvolver um site responsivo de sorteio de números. O usuário poderá escolher quantos números deseja sortear, definir um intervalo mínimo (range) e visualizar o resultado em tempo real. Além disso, será possível ativar a opção para não repetir números no sorteio. O foco está em construir uma interface clara e funcional, adaptada para desktop e mobile, aplicando boas práticas de HTML, CSS e JavaScript para manipular os números de forma dinâmica.

## Conhecendo o projeto
![Conhecendo o projeto](./github/1758211965188.png)

Neste desafio, você vai desenvolver um site responsivo de sorteio de números. O úsuário poderá escolher quantos números deseja sortear, definir um intervalo mínimo e máximo (range) e visualizar o resultado em tempo real. Além disso, será possível ativar a opção para não repetir números no sorteio. O foco está em construir uma interface clara e funcional, adaptada para desktop e mobile, aplicando boas práticas de HTML, CSS e JavaScript para manipular os números de forma dinâmica.

## Recursos
Materiais para você usar como base para o desenvolvimento
[Veja o projeto no Figma](https://www.figma.com/pt-br/comunidade/file/1397279380752780744/sorteador-de-numeros)
...
* Deve haver a opcão de não repetir números.
...
* Se a opção nnao repetir estiver ativada, nenhum número sorteado pode se repetir.
...
- [ ] Criar a estrutura do projeto com pastas e arquivos HTML, CSS e JS;
- [ ] Linkar o CSS e o JS no arquivo HTML;
- [ ] Adicionar título principal e seção de explicação no HTML;
- [ ] Criar formulário com campos para quantidade, mínimo, máximo e opção "Não repetir número";
- [ ] Adicionar botão "Sortear" e área para exibir mensagens e resultados;
- [ ] Aplicar reset/normalize básico no CSS;
- [ ] Definir variáveis de cores, fontes e espaçamentos no CSS;
- [ ] Estilizar layout com duas colunas explicacnao e formulário;
- [ ] Estilizar inputs, botão e área de resultados;
- [ ] Criar estilo para mensagens de erro e sucesso;
- [ ] Tornar a página responsiva para desktop, tablet e mobile;
- [ ] Adicionar labels e aria-live para acessibilidade;
- [ ] Validar se os campos não estão vazios;
- [ ] Validar se o máximo é maior que o mínimo;
- [ ] Validar se a quantidade não ultrapassa o intervalo quando "Não repetir" estiver marcado;
- [ ] Mostrar mensagens de erro claras quando as validações falharem;
...
- [ ] Limpar os resultados anteriores antes de cada sorteio;
- [ ] Adicionar animação simples antes de exibir os números;
- [ ] Desabilitar o botão durante a animação e reabilitar ao final;
- [ ] Mostrar mensagem de sucesso após o sorteio;
